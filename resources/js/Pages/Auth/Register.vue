        ...
        <div class="bg-white rounded-lg shadow p-8 w-full max-w-md">
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-4">
                    ...
                    <input v-model="form.phone" type="tel" class="w-full border px-4 py-2 rounded" required />
                ...
                <div class="mb-4">
                    ...
                    <input v-model="form.password" type="password" class="w-full border px-4 py-2 rounded" required />
                    <div v-if="form.errors.password" class="text-red-600 text-sm mt-1">{{ form.errors.password }}</div>
                </div>

                <div class="mb-6">
                    <label class="block mb-2 font-semibold">تأكيد كلمة المرور</label>
                    <input v-model="form.password_confirmation" type="password" class="w-full border px-4 py-2 rounded" required />
                </div>
            ...
            <div class="mt-6 text-center">
                <Link href="/login" class="text-blue-600 hover:underline">لديك حساب بالفعل؟ سجل الدخول</Link>
            </div>
        </div>
    </div>
</template>
